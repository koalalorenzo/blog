...
{{< figure src="hello-example.webp" caption="Example of a Meme generated using the Bot" class="small" >}}
...
{{< image src="shortcuts-twitch-gen.webp" caption="My Shortcut to generate Memes from my iPhone" tag="#noborder#big" >}}
